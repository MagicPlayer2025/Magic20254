...
<section class="page-hero">
    ...
    <div class="container page-hero__content">
        ...
        <div class="breadcrumb">
            <a href="{{ route('home') }}">Главная</a> / <span>О нас</span>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="history-grid">
            ...
            <div class="history__image">
                <img src="{{ asset('images/about/salon.png') }}" alt="Интерьер салона StyleCut">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="masters-grid">
            ...
            <div class="master-card">
                ...
                <p class="master-card__exp">Опыт работы: {{ $master->experience_years }} {{ $master->experience_years >= 5 ? 'лет' : 'года' }}</p>
            </div>
            @endforeach
        </div>
    </div>
    ...
    <div class="container">
        <div class="choose-grid">
            <div class="choose__image">
                <img src="{{ asset('images/about/barber-work.png') }}" alt="Мастер за работой">
            </div>
