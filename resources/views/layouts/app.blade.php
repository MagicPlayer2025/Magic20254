...
<head>
    ...
    <title>@yield('title', 'StyleCut — Парикмахерская')</title>
    ...
    <header class="header">
        <div class="container header__inner">
            ...
            <nav class="header__nav">
                ...
                <a href="{{ route('services') }}" class="nav-link {{ request()->routeIs('services') ? 'active' : '' }}">Услуги</a>
                <a href="{{ route('about') }}" class="nav-link {{ request()->routeIs('about') ? 'active' : '' }}">О нас</a>
                <a href="{{ route('gallery') }}" class="nav-link {{ request()->routeIs('gallery') ? 'active' : '' }}">Галерея</a>
            ...
            <div class="header__actions">
                <a href="tel:+{{ $sitePhoneHref }}" class="header__phone">{{ $sitePhone }}</a>
                @auth
                    @if(auth()->user()->is_admin)
                        <a href="{{ route('admin.dashboard') }}" class="nav-link">Админка</a>
                    @endif
                    <a href="{{ route('profile') }}" class="nav-link">Кабинет</a>
                ...
                @endauth
                <a href="{{ route('appointment') }}" class="btn btn--primary">Записаться</a>
            </div>
        ...
        <div class="container">
            <div class="footer__top">
                ...
                <div class="footer__col">
                    ...
                    <ul>
                        <li>{{ $sitePhone }}</li>
                        <li>{{ \App\Models\SiteSetting::getValue('email', 'info@stylecut.ru') }}</li>
                        <li>{{ \App\Models\SiteSetting::getValue('address', 'г. Москва, ул. Примерная, 123') }}</li>
            ...
            <div class="footer__bottom">
                ...
                <a href="{{ route('register') }}">Личный кабинет</a>
            </div>
        </div>
    </footer>
